          ...
          <section className={styles.orders}>
            {orders.map((order, i) => (
              <Link key={i} href={{ pathname: '/manager/viewOrder', query: { oid: order.id } }} className={styles.order}>
                ...
                {order.cart[0].el.image.format === 'png' ?
                  <Image className="contain" alt="" src={order.cart[0].el.image.url} height={60} width={60} />
                  :
                  <Image className="cover" alt="" src={order.cart[0].el.image.url} height={60} width={60} />
                }
                <article>
